# -*- coding: utf-8 -*-
"""
Created on Wed Aug 21 11:31:57 2019
...
for year in yearlst:
    ...
    for i in range (0, len(fld_lst), 1):
        ...
        act_atm_fl = act_fld+'/output_'+year+'_mon_'+fld_lst[i]+'.nc'
        act_srf_pr = act_fld+'/output_'+year+'_pressure_mon_'+fld_lst[i]+'.nc'
    
    
        act_nc_fl = Dataset(act_atm_fl, 'r', format='NETCDF3_64BIT')
        print ("Read VAS")
        vas_var = act_nc_fl.variables['v'][:]
